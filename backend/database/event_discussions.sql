-- Event discussion / messaging workflow (additive patch)
...
-- Revokes discussion access without changing or deleting the attendee's
-- registration. Existing messages remain part of the event record.
